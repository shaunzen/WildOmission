...
public class Deployables : ModuleRules
{
    public Deployables(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PrivateDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "InputCore", "SlateCore", "NavigationSystem", "Niagara", "Crafting", "Despawner", "Durability", "GatherableResources", "Interaction", "Locks", "Weather" });
    }
}