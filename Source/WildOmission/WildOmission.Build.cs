...
public class WildOmission : ModuleRules
{
	public WildOmission(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "Slate", "SlateCore", "OnlineSubsystem", "OnlineSubsystemSteam", "Inventory", "EquipableItems", "Interaction", "Despawner", "Helpers" });
	}
}
