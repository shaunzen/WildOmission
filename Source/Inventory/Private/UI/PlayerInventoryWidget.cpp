...
void UPlayerInventoryWidget::Setup(UInventoryMenuWidget* InParentMenu, UInventoryComponent* InInventoryComponent)
{
	Super::Setup(InParentMenu, InInventoryComponent);
